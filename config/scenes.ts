...
export const SCENES: Scene[] = [
  ...
  {
    "id": "chinese_polyphones",
    "title": "Chinese Polyphones",
    "description": "Chinese sentences with polyphonic characters to test pronunciation accuracy",
    "sentences": {
      "zh-CN": [
        // 单（shàn）老师讲解历史时提到，匈奴单（chán）于的骑术远超现代人骑单（dān）车的技术
        "单老师讲解历史时提到，匈奴单于的骑术远超现代人骑单车的技术。",
        // 他出差（chāi）时总犯小差（chā）错，这次差（chà）不多要搞砸项目
        "他出差时总犯小差错，这次差不多要搞砸项目。",
        // 银行（háng）门口施工，行人（xíng）只能绕道。
        "银行门口施工，行人只能绕道。",
        // 他在耆艾（ài）之年得了重病，整日自怨自艾（yì）
        "他在耆艾之年得了重病，整日自怨自艾。",
        // 薄（báo）饼夹着薄（bò）荷叶，香气飘过晨间薄（bó）雾
        "薄饼夹着薄荷叶，香气飘过晨间薄雾。",
        // 牧民畜（xù）养的牛羊，是草原上最重要的家畜（chù）
        "牧民畜养的牛羊，是草原上最重要的家畜。",
        // 他夺冠（guàn）后，戴上冠（guān）冕接受采访
        "他夺冠后，戴上冠冕接受采访。",
        // 天气暖和（huo），小和（hé）在家和（huó）泥修墙
        "天气暖和，小和在家和泥修墙。",
        // 鱼挣扎（zhá）时，鱼刺扎（zhā）破了他的手，他匆忙包扎（zā）
        "鱼挣扎时，鱼刺扎破了他的手，他匆忙包扎。",
        // 他叼着雪茄（jiā），边吃番茄（qié）边看报纸
        "他叼着雪茄，边吃番茄边看报纸。"
      ]
    },
    "tags": ["polyphones"]
